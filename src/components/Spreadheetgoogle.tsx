    ...
    <div className="">
      ...
      {initialData.map((row, index) => (
        <div key={`data-${index}`} className="flex border-t border-l border-gray-50">
          ...
          {/* Priority cell with conditional styling */}
        ...
        <div key={`input-${index}`} className="flex border-t border-l border-gray-50">
          ...
          <div className="h-[25px] w-[248px] px-2 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              ...
              onChange={(e) =>
                handleInputChange(index, "jobRequest", e.target.value)
              }
            />
          </div>
          ...
          <div className="h-[25px] w-[127px] px-1 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              ...
              value={row.submitted}
              onChange={(e) =>
                handleInputChange(index, "submitted", e.target.value)
              }
            />
          </div>


          <div className={`h-[25px] w-[127px] px-1 flex justify-between items-center border-b border-r border-gray-50 ${row.status ? getStatusStyle(row.status) : ''}`}>
            <input
              type="text"
              className="text-[12px] font-light w-full bg-transparent outline-none"
              value={row.status}
          ...
          <div className="h-[25px] w-[127px] px-1 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              ...
              value={row.submitter}
              onChange={(e) =>
                handleInputChange(index, "submitter", e.target.value)
              }
            />
          </div>
          ...
          <div className="h-[25px] w-[140.5px] px-1 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              ...
              value={row.assigned}
              onChange={(e) =>
                handleInputChange(index, "assigned", e.target.value)
              }
            />
          </div>
          ...
          <div className="h-[25px] w-[140px] px-1 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              type="text"
              className={`text-[12px] font-light w-full bg-transparent outline-none ${row.priority ? getPriorityStyle(row.priority) : ''}`}
              value={row.priority}
              onChange={(e) =>
          ...
          <div className="h-[25px] w-[140px] px-1 flex justify-between items-center border-b border-r border-gray-50 ">
            <input
              ...
              value={row.estValue}
              onChange={(e) =>
                handleInputChange(index, "estValue", e.target.value)
              }
            />
          </div>
